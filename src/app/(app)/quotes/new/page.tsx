    ...
    <div className="min-h-full pb-24">
      ...
      <div className="px-4 py-5 max-w-2xl mx-auto space-y-8">
        ...
        <section>
          ...
          <div className="space-y-4">
            <Input label="שם מלא *" placeholder="ישראל ישראלי" value={customerName} onChange={(e) => setCustomerName(e.target.value)} error={errors.customerName} />
            <div className="grid grid-cols-2 gap-3">
              <Input label="טלפון *" placeholder="050-0000000" value={customerPhone} onChange={(e) => setCustomerPhone(e.target.value)} error={errors.customerPhone} type="tel" dir="ltr" />
