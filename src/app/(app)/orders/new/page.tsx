...
export default function NewOrderPage() {
  ...
  return (
    <div className="min-h-full pb-24">
                ...
                <div className="hidden md:flex items-center justify-center">
                  {items.length > 1 && (
                    <button
                      type="button"
                      onClick={() => removeItem(item.id)}
                      className="flex items-center justify-center w-9 h-9 rounded-[6px] text-[#52525b] hover:text-red-400 hover:bg-red-500/10 transition-colors"
                    >
                      <Trash2 size={14} />
                    </button>
                  )}
      ...
      {/* Sticky bottom bar */}
      <div className="fixed bottom-0 inset-x-0 z-40 bg-[#09090b]/90 backdrop-blur border-t border-[#27272a] px-4 py-3 flex items-center justify-between gap-3 md:px-6"
